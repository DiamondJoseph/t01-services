To request an Ingress for `t01-blueapi.diamond.ac.uk` in the `t01-beamline` namespace:
...
2. Provide the following details:
    ...
    - **Cluster Name:**  
      Use `k8s-t01` in the description if the cluster is not Argus or Pollux.
    - **Namespace Name:**  
      `t01-beamline`
    - **Ingress Name:**  
...
3. Add the client id, client secret and cookie secret to `templates/secret.yaml`:
  ...
  ```
  echo -n <secret> | kubeseal --raw --namespace t01-beamline --name blueapi-secret
  ```
