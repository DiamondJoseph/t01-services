...
3. Confirm that RabbitMQ is reachable at `t01-rabbitmq-daq.diamond.ac.uk`.
4. Specify the User ID in the security context to allow writing Nexus files. Typically, this should be set to `t01-detector` UID and GID. 
    You can find these by running: `id t01-detector`
